CXX := clang++
CXXFLAGS := -std=c++17 -ftrapv -Weverything -Wno-exit-time-destructors -Wno-global-constructors -Wno-c++98-c++11-compat-binary-literal -Wno-c++98-compat -Wno-c++98-compat-pedantic
